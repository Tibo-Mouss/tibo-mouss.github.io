var french_translations = {
    ...
    "justwatch_work_created_canary_system": "🏆 Créé un système automatisé de déploiement de versions de test privées en prod",
    "justwatch_work_canary_system_description": `&ensp; Gain de ~2 heures 
        par test et possibilité pour des externes de prévisualiser les fonctionnalités via des URL sécurisées`,
    "justwatch_work_payment_title": `📝 Refactorisé l'ancien système de paiement afin d'améliorer la 
        lisibilité, la stabilité et la surveillance.`,
    "justwatch_work_payment_description": `&ensp; Réduction de 60 % des réclamations clients grâce au monitoring d'erreurs, 
        plutôt qu'à partir des réclamations elles-mêmes.`,
    "justwatch_work_talks": `🎤 Conférences de présentation de nouveaux outils : eBPF, Grafana, monitoring custom...`,
    "justwatch_work_caches_title": `🔄 Remplacement des caches Scylla par des caches Redis dans tous les services.`,
    "justwatch_work_caches_description": `&ensp; Economisé des milliers d'euros en évitant de renouveler l'abonnement de BDD Scylla.`,
    "justwatch_work_key_features_title": `👨‍💼 Responsable de plusieurs fonctionnalités clés du site web :`,
    "justwatch_work_key_features_description": `Page d'accueil éditoriale, Location de films,
        Offres internationales, PlayOnTV depuis un appareil mobile, ...`,
    ...
    "Multiplayer_2D": "Jeu Multijoueur 2D en ligne (Unity & UE)",
    "Self_Learning": "Autodidacte",
    "UE_Gamedev_courses": "Cours Unreal Engine GameDev.tv",
    "Engine_dev_pok_fan_game": "Développeur moteur de Jeu",
    ...
    "sgn_asso_description": `Le <b style="color: darkorange;">SGN</b>
        ...
        l'esport étudiant.`,
    "GA_description": `
        &ensp; J'étais présent à l'édition 2024 de la Gamer's Assembly,
        en tant que <b style="color: darkorange;">Chargé de Communication</b>
        pour mon association.
        <br> <br>
        &ensp; J'ai créé des assets pour les streams, relayé les événements
        sur les réseaux sociaux,
        filmé et édité des interviews de joueurs :`,
    "Grosse_Ligue_description": `
        &ensp; La Grosse Ligue est une compétition nationale étudiante,
        en partenariat avec Riot Games et University Esports.
        <br> <br>
    ...
    "casting_observing_description": `
        ...
        <br> <br>
        &ensp; J'ai commencé à commenter des parties au début de l'année 2023 lors
    ...
    "TVn7_asso_description": `
        ...
        pour des événements, des entreprises privées,
        l'école et les étudiants de mon école d'ingénieur.`,
    "Inter_Agros_description": `
        &ensp; Les Inter Agros sont des évènements
        sportifs étudiants qui se déroulent chaque année pendant un week-end
        prolongé et rassemblent environ 2000 personnes.
        <br> <br>
        &ensp; J'étais là avec l'équipe de TVn7 (~ 15) pour produire le 
        <b style="color: darkorange;">contenu quotidien</b> diffusé chaque
        soir pour les participants.
        <br> <br>
        &ensp; Vous pouvez accéder à toutes les vidéos faites ici à droite ⏩ ⏩`,
    "Graduation_Prom": "Bal des Diplômés",
    "Graduation_Prom_description": `
        &ensp; J'ai été chargé de filmer le bal de fin d'études d'élèves d'autres
        années pour en faire un after-movie.
        <br> <br>
        &ensp; C'est très gratifiant de participer à ces projets. C'est une façon
        de figer un souvenir fort dans le temps pour les diplômés.`,
    "JT_description": `
        &ensp; La majeure partie de mon travail à TVn7 consistait
        à créer des clips humoristiques pour les étudiants.
        <br> <br>
    ...
    "net_entraide_asso_routine": `
        &ensp; Chaque samedi, nous nous réunissions pour parler
        d'un sujet spécifique, sensibiliser aux choses à faire et à ne pas
        faire sur les sites web, et comment optimiser les boîtes aux lettres, ... 
        <br> <br>
        &ensp; Je suis devenu le <b style="color: #c112c1;">trésorier</b> en 2018.`,
    "Laval_Virtual_description": `
        &ensp; Nous avions la possibilité d'avoir un
        <b style="color: #c112c1;">stand</b> à Laval
        Virtual chaque année, grâce à la générosité de l'équipe organisatrice.
        <br> <br>
        &ensp; Nous <b style="color: #c112c1;">animions des livestreams</b>
        sur la technologie
    ...
    "Airbus_projects_intro": `
        ...
        différents chez Sopra Steria : `,
    "AeroExcellence_description": `
        &ensp; &ensp; Il s'agit d'un site permettant aux sous-traitants du GIFAS
        d'obtenir des certifications.
        <br>
        J'ai travaillé sur le backend django sur 
        l'exportation de la base de données en fichiers csv, appels API ...`,
    "Way_mobile_app": "• Appli Mobile W@y : (Kotlin, Android)",
    "Way_mobile_app_description": `
        &ensp; &ensp; Il s'agit d'une application interne d'Airbus conçue pour
        gérer l'approvisionnement et la livraison de pièces d'avions.
        <br>
        Responsable des écrans d'affichage de la carte interactive et
        de gestions des rôles utilisateurs.`,
    "Omniverse_description": `
        &ensp; Le projet consistait à simuler une chaîne de fabrication
        de drones dans le nouveau moteur 3D de Nvidia, appelé Omniverse.
        (Python)
        <br> <br>
        &ensp; J'étais chargé de coder les mouvements des multiples robots
        opérationnels (déplacement/assemblage de pièces détachées...).`,
    "FauxPilot_description": `
        &ensp; J'ai testé les capacités et les limites d'un outil similaire
        à Github Copilot en vue d'une éventuelle mise en œuvre dans l'entreprise.
        <br> <br>
        &ensp; J'ai également développé une <b style="color: darkorange;">Extension</b>
        de test <b style="color: darkorange;">Intellij</b> en
        Kotlin pour tester l'outil en conditions réelles.
        Elle présentait les caractéristiques suivantes :
        <br>`,
    "FauxPilot_description_item1": `&ensp; &ensp;
        • Autocomplétion de lignes / blocs de code par IA
        (déclenchable par raccourci personnalisable ou
         bouton de menu contextuel)`,
    "FauxPilot_description_item2": `&ensp; &ensp;
...
function init() {
    ...
    // Change language if the lang url parameter has been set
    if (trad_url_param) {
...
function getEnglishTrad() {
    for (let i = 0; i < translationLinks.length; i++) {
        translations['EN'][translationLinks[i].getAttribute("trad")] = translationLinks[i].innerHTML;
    }
}
...
const TEST_BASE_URL = "file:///D:/Documents/GitHub/portfolio/index.html";
const BASE_URL = "https://tibo-mouss.github.io/";

function getFullURL() {
    return TEST_BASE_URL + "?landing=" + current_page + "&lang=" + current_lang;
}


// Used in the html code to change language
